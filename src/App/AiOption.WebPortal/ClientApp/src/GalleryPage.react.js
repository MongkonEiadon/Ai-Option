...
sm = { 6 };
lg = { 4 };
key = { key } >  < GalleryCard >  < GalleryCard.Image;
src = { item.imageURL };
alt = { `Photo by ${item.fullName}` } /  >  < GalleryCard.Footer >  < GalleryCard.Details;
avatarURL = { item.avatarURL };
fullName = { item.fullName };
dateString = { item.dateString } /  >  < GalleryCard.IconGroup >  < GalleryCard.IconItem;
name = "eye";
label = { item.totalView } /  >  < GalleryCard.IconItem;
name = "heart";
