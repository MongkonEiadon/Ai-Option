...
namespace iqopoption.core {
    public interface ISession : IMediator {
    }

    public class SessionWrapper : Mediator, ISession {
        public SessionWrapper(ServiceFactory serviceFactory) : base(serviceFactory) {
        }
...
namespace MediatR {
    ...
    ///     <see cref="IRequestPostProcessor{TRequest,TResponse}" /> implementations and registers them as scoped instances
    ...
    public static class ServiceCollectionExtensions {
        ...
        public static IServiceCollection AddMediatR(this IServiceCollection services) {
            return services.AddMediatR(AppDomain.CurrentDomain.GetAssemblies().Where(a => !a.IsDynamic));
        }
        ...
        public static IServiceCollection AddMediatR(this IServiceCollection services, params Assembly[] assemblies) {
            return services.AddMediatR(assemblies.AsEnumerable());
        }
        ...
        public static IServiceCollection
            AddMediatR(this IServiceCollection services, IEnumerable<Assembly> assemblies) {
        ...
        public static IServiceCollection AddMediatR(this IServiceCollection services,
            ...
            return services.AddMediatR(handlerAssemblyMarkerTypes.AsEnumerable());
        }
        ...
        private static void AddRequiredServices(IServiceCollection services) {
            ...
            services.AddScoped<ISession, SessionWrapper>();
        }
    }
}